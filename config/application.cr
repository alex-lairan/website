...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Lairan Website web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 1mUBhbYqZ0ec24ekAr7eqoxKyXzyeLKdnWX2iDGGvt4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("lairan_website.log", "w"))
  #
  #
end
